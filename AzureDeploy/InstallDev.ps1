...
.\Deploy-AzureResourceGroup.ps1 `
    ...
    -ResourceGroupName TeamsProvDev`
    -TemplateParametersFile sample.parameters.json

# Ensure storage queues are in place
$storageAccount = Get-AzureRmStorageAccount | Where-Object ResourceGroupName -eq "TeamsProvDev"
